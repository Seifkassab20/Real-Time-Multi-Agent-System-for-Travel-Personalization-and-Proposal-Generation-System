...
```json
{
  ...
  "budget_amount": "decimal number or null",
  "budget_currency": "EGP (default)",
  "adults": "integer or null",
  "children": "integer or null",
  "ages": ["list of integers or null"],
  "cities": ["list of strings or null"],
  "specific_sites": ["list of strings or null"],
  "interests": ["list of strings or null"],
  "accommodation_preference": "string or null",
  "tour_style": "string or null",
...
- **call_id**: Unique identifier for this conversation (system-generated)
- **start_date**: Trip start date
- **end_date**: Trip end date
- **budget_amount**: Budget in numeric value
- **budget_currency**: Currency code (default: EGP)
- **adults**: Number of adult travelers (>= 0)
- **children**: Number of child travelers (>= 0)
- **ages**: List of ages for all travelers (especially children)
- **cities**: Destination cities
- **specific_sites**: Specific attractions or sites to visit
- **interests**: Travel interests (e.g., adventure, culture, relaxation)
- **accommodation_preference**: Hotel preference (e.g., luxury, budget, boutique)
- **tour_style**: Preferred tour style (e.g., guided, independent, mixed)
- **created_at**: Timestamp when profile was created (system-generated)
- **last_updated**: Timestamp of last update (system-generated)
...
3. **Budget**: budget_amount, budget_currency
4. **Preferences**: interests, tour_style, accommodation_preference
5. **Specifics**: specific_sites
...
- fields_filling: ["start_date", "end_date"]
...
- fields_filling: ["budget_amount", "budget_currency"]
- Or if only amount missing: "Do you have a budget in mind for this trip?"
- fields_filling: ["budget_amount"]

**Destination (cities, specific_sites)**:
...
- fields_filling: ["accommodation_preference"]

**Tour style**:
- "How do you prefer to explore? Would you like guided tours, independent travel, or a mix of both?"
- fields_filling: ["tour_style"]

## Important Rules

1. **Never ask about**: profile_id, call_id, created_at, last_updated (system-generated fields)
...
```json
{
  ...
  "call_id": "987fcdeb-51a2-43d1-b789-123456789abc",
  "start_date": null,
  "end_date": null,
  "budget_amount": null,
  "budget_currency": "EGP",
...
```json
{
  "questions": [
    {
      "question": "When would you like to start your trip, and how many days are you planning to travel?",
      "fields_filling": ["start_date", "end_date"]
    },
    {
    ...
    {
      "question": "What's your approximate budget for this trip, and which currency would you prefer to work with?",
      "fields_filling": ["budget_amount", "budget_currency"]
    },
    {
...
- If budget_currency is missing but budget_amount exists, ask about preferred currency separately
